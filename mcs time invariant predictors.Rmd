...
## Predictors for linear growth models 
There are time-varying predictors (TVP) and time-invariant predictors (TIP. This Rmd is to filter potential predictors for the lgms.
Current predictors include sex, ethnicity, mother's highest educational attainment, deprivation, and intellectual disability/intelligence.

As according to PCA screening, no autistic children were labelled as intellectual disability, the PC score of the first component (PC1 score) was used as the TIP.
